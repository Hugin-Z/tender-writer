...
def set_run_font(run, ascii_font="Times New Roman", east_asia="宋体",
                 size_pt=14, bold=False, color=None):
    """
    设置某个 run 的中英文字体字号。
...
def add_table(doc: Document, headers: list, rows: list,
              header_east_asia="仿宋_GB2312",
              body_east_asia="仿宋_GB2312",
              size_pt=10.5):
    """
...
def main():
    ...
    print("  - 每写一章,通过 docx_builder 的 add_chapter / add_paragraph / ")
    print("    add_table 接口追加到此骨架中")
